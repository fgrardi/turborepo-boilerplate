...
import { Card } from '../../../packages/ui/dist/components/card';
import { Gradient } from '../../../packages/ui/dist/components/gradient';
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-between p-24">
			...
			<div className="relative flex place-items-center">
				<div
					className={`
						relative z-0 flex w-auto flex-col items-center justify-between gap-8 pt-[48px] pb-16 font-sans
						md:pt-16 md:pb-24
						lg:pt-20 lg:pb-32
					`}
				>
					...
					<div
						className={`
							z-50 flex flex-col items-center justify-center gap-5 px-6 text-center
							lg:gap-6
						`}
					>
						<svg
